...
-- Purpose: Stores GK_COMPLETE_* and TQG_PASS_* tokens for verification and test quality
-- =============================================================================
CREATE TABLE completion_tokens (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    session_id TEXT NOT NULL,
    token_type TEXT NOT NULL,              -- 'GK_COMPLETE' or 'TQG_PASS'
...
-- =============================================================================
-- Table: phase_tokens
-- Purpose: Stores PVG_COMPLETE_* tokens for phase verification gates
-- =============================================================================
CREATE TABLE phase_tokens (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    session_id TEXT NOT NULL,
    token_value TEXT NOT NULL UNIQUE,      -- full token PVG_COMPLETE_[32hex]
