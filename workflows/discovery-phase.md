...
Produces DISCOVERY.md (for Level 2-3) that informs task planning and plan.yaml creation.

Called from planning workflows with a depth parameter, or directly via /research command.

NOTE: For comprehensive ecosystem research ("how do experts build this"), use /research directly, which produces DISCOVERY.md.
</purpose>
...
**Depth is determined by the planning workflow before routing here, or by the /research command invocation.**
</depth_levels>
...
Cross-verify any WebSearch finding with Context7/official docs.
</source_hierarchy>

<process>

<step name="determine_depth">
Check the depth parameter passed from the planning workflow or /research command:
...
4. **If verified:** Return to planning workflow with confirmation. No DISCOVERY.md needed.
...
8. Return to planning workflow.

**Output:** `DISCOVERY.md` (comprehensive)
</step>
...
1. Continue planning with /research for deeper investigation
2. Proceed to task planning
