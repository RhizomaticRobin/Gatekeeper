...
- Key files: project.md, roadmap.md, task-prompt.md
...
- Key files: execute-task.md, research-phase.md
- Subdirectories: None
...
- `CLAUDE.md` - Instructions for the agent when working in this repo
...
- Usage: Reference from command with workflow path
...
**templates/**
- Purpose: Resources for project initialization
- Source: Used during project setup
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands for the agent
- Source: Loaded by the agent at runtime
- Committed: Yes (source of truth)
